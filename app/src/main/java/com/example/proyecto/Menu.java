...
public class Menu extends AppCompatActivity implements View.OnClickListener{
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()){
            ...
            case R.id. cardEncuestar: i=new Intent(this,MenuEncuestas.class);startActivity(i);break;
            case R.id.cardRegistros: ;break;
    ...
    private void irLogin(){
        Intent irlogin = new Intent(this,MainContent.class);
